 ...
 */
class Noise extends \Notice\Model\Noise implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = array('domiporta' => NULL, 'otodom' => NULL);
    ...
    {
        unset($this->domiporta, $this->otodom);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'domiporta', 'otodom');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Noise $proxy) {
