...
class Province extends \Notice\Model\Province implements \Doctrine\ORM\Proxy\Proxy
{
     ...
     */
    public static $lazyPropertiesDefaults = array('provinceName' => NULL, 'otodom' => NULL, 'domiporta' => NULL);
    ...
    {
        unset($this->provinceName, $this->otodom, $this->domiporta);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'inputFilter', 'id', 'provinceName', 'otodom', 'domiporta');
        }
