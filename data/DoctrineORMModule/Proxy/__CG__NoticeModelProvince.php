 ...
 */
class Province extends \Notice\Model\Province implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = array('provinceName' => NULL, 'nameOtodom' => NULL, 'nameDomiporta' => NULL);
    ...
    {
        unset($this->provinceName, $this->nameOtodom, $this->nameDomiporta);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'inputFilter', 'id', 'provinceName', 'nameOtodom', 'nameDomiporta');
        }
