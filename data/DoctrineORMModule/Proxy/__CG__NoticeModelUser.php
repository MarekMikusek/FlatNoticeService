 ...
 */
class User extends \Notice\Model\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = array('userName' => NULL, 'phone' => NULL, 'email' => NULL, 'licence' => NULL);
    ...
    {
        unset($this->userName, $this->phone, $this->email, $this->licence);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'inputFilter', 'id', 'userName', 'phone', 'email', 'licence');
        }
